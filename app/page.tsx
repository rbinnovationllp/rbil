...
const products = [
  ...
  },
  {
    ...
    description:
      'An AI-powered platform combining business accounting assistance with personal finance and tax-planning support through two dedicated intelligent service modules.',
    users:
      'Individuals, professionals, small businesses, entrepreneurs and growing enterprises',
...
const quickLinks = [
  ...
  {
    title: 'Five Projects, One Vision',
  ...
  },
  {
    ...
    text: "Discover the growth opportunity behind RBIL's five AI platforms",
    href: '#investors',
    Icon: ShieldCheck,
    featured: true,
  },
...
const hiProducts = {
  ...
  mylekhpal: {
    category: 'AI लेखांकन और व्यक्तिगत वित्त',
    hook: 'Business books से personal finances तक - हर rupee को accounted रखने में AI से सहायता लें।',
    description:
      'Business accounting assistance, personal finance और tax-planning support को दो dedicated intelligent service modules में जोड़ने वाला AI-powered platform.',
    users:
      'Individuals, professionals, small businesses, entrepreneurs और growing enterprises',
  },
} as const;

const hiQuickLinks = {
  'Our Innovations': ['हमारे Innovations', 'RBIL के AI solutions देखें'],
  'Five Projects, One Vision': ['पांच Projects, एक Vision', 'देखें हम क्या बना रहे हैं'],
  ...
  'Investor Relations': ['Investor Relations', 'RBIL के पांच AI platforms के growth opportunity को जानें'],
...
const getBuildVisitorCounterEndpoint = () => {
...
const getVisitorCounterEndpoint = async () => {
  const buildEndpoint = getBuildVisitorCounterEndpoint();
  ...
  try {
    const response = await fetch('/visitor-counter-config.json', {
      cache: 'no-store',
      credentials: 'omit',
    });
    ...
    return typeof data.endpoint === 'string' ? data.endpoint.trim() : '';
  } catch {
    return '';
  }
};
...
export default function Home() {
  ...
  useEffect(() => {
    ...
    const registerVisit = async () => {
      const endpoint = await getVisitorCounterEndpoint();
    ...
    <main>
      ...
      <section className="hero" id="home">
        ...
        <div className="hero-visual" aria-label="Rashi Bhartiya Innovation solution ecosystem">
          <div className="visual-core">
            ...
            <strong>{isHindi ? 'पांच Solutions' : 'Five Solutions'}</strong>
          </div>
      ...
      <section className="section" id="products">
        <div className="section-head">
          ...
          <h2>{isHindi ? 'पांच Solutions. एक Human-Centred Mission.' : 'Five Solutions. One Human-Centred Mission.'}</h2>
          <p>
            {isHindi
          ...
          {displayProducts.map(({ id, name, category, hook, description, users, url, image, imageAlt, hackathon, accent, Icon }) => (
            <article className={`product-card ${accent}`} id={id} key={name}>
              <a className="product-thumb" href={url} target="_blank" rel="noopener noreferrer">
                <img src={image} alt={imageAlt} loading="lazy" onError={handleImageFallback} />
              </a>
      ...
      <section className="section impact" id="impact">
        ...
        <div className="impact-grid">
          ...
          <span>{isHindi ? 'AI-assisted accounting, personal finance और tax-planning readiness' : 'AI-assisted accounting, personal finance and tax-planning readiness'}</span>
        </div>
      </section>
